...
const navIcon1: string = require("../assets/img/nav-icon1.svg").default;
const navIcon2: string = require('../assets/img/nav-icon2.svg').default;
const navIcon3: string = require('../assets/img/nav-icon3.svg').default;
